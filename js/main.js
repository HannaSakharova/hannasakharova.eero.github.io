...
//Tabs
$('.potential__link').click(function (e) {
	e.preventDefault();
	$('.potential__link').removeClass('potential__link-active');
	$('.potential__content-item').removeClass('potential__content-item--active');
	$(this).addClass('potential__link-active');
	$($(this).attr('href')).addClass('potential__content-item--active');
});
$('.potential__link:first-child').click();

$('.reviews__link').click(function (e) {
	e.preventDefault();
	$('.reviews__link').removeClass('reviews__link-active');
	$('.reviews__item').removeClass('reviews__item-active');
	$(this).addClass('reviews__link-active');
	$($(this).attr('href')).addClass('reviews__item-active');
});
$('.reviews__link:first-child').click();


//Section 'Find your system'  
$('.system__link:first-child').click(function (e) {
	e.preventDefault();
	$('.system__content-item').removeClass('system__content-item--active');
	$(this).addClass('system__link-active');
	$($(this).attr('href')).addClass('system__content-item--active');
});

$('.system__link:first-child').click();
$('.content-system__btn').click(function () {
	$(this).siblings().removeClass('content-system__btn--active');
	$(this).addClass('content-system__btn--active');
});

$('.system__btn-1').click(function (e) {
	e.preventDefault();
	if ($('.content-system__btn-1').hasClass('content-system__btn--active')) {
		$('.system__link-2').addClass('system__link-active');
		$('.system__content-item').removeClass('system__content-item--active');
		$($('.system__btn-1').attr('href')).addClass('system__content-item--active');
	} else {
		$('.content-system__btn').addClass('content-system__btn--err');
		$('.content-system__btn').click(function () {
			$('.content-system__btn').not(this).removeClass('content-system__btn--err');
			$(this).removeClass('content-system__btn--err');
			$(this).siblings().removeClass('content-system__btn--active');
			$(this).addClass('content-system__btn--active');
		});
	}
});
$('.system__btn-2').click(function (e) {
	e.preventDefault();
	if ($('.content-system__btn-2').hasClass('content-system__btn--active')) {
		$('.system__link-3').addClass('system__link-active');
		$('.system__content-item').removeClass('system__content-item--active');
		$($('.system__btn-2').attr('href')).addClass('system__content-item--active');
	} else {
		$('.content-system__btn').addClass('content-system__btn--err');
		$('.content-system__btn').click(function () {
			$('.content-system__btn').not(this).removeClass('content-system__btn--err');
...
$('.system__btn-3').click(function (e) {
	e.preventDefault();
	if ($('.content-system__btn-3').hasClass('content-system__btn--active')) {
		$('.system__link-4').addClass('system__link-active');
		$('.system__content-item').removeClass('system__content-item--active');
		$($('.system__btn-3').attr('href')).addClass('system__content-item--active');
	} else {
		$('.content-system__btn').addClass('content-system__btn--err');
		$('.content-system__btn').click(function () {
			$('.content-system__btn').not(this).removeClass('content-system__btn--err');
...
$('.system__btn-4').click(function (e) {
	e.preventDefault();
	if ($('.content-system__btn-4').hasClass('content-system__btn--active')) {
		$('.system__body').addClass('system__body--hide');
		$('.system__ideal').addClass('system__ideal--active');
	} else {
		$('.content-system__btn').addClass('content-system__btn--err');
		$('.content-system__btn').click(function () {
			$('.content-system__btn').not(this).removeClass('content-system__btn--err');
